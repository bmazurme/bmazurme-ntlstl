...
export default function Tech({ info }: { info: IProfile}) {
  const techList = ['JavaScript', 'TypeScript', 'React.js', 'Vue.js', 'Next.js', 'Express.js', 'Redux', 'RTK', 'Jest', 'Webpack', 'Parcel', 'PostCSS', 'Eslint', 'MUI', 'Tailwind', 'BEM', 'Canvas', 'MongoDB', 'PostgreSQL', 'Git', 'Docker', 'CSR', 'SSR', 'REST API', 'Axios', 'Figma'];
